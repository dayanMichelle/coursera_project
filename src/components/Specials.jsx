...
export const Specials = () => {
  ...
  >
    <div style={{ display: "flex", justifyContent: "space-around", alignItems:"center" }}>
      <h4 style={{fontSize:"40px", fontWeight:"bold"}}>This weeks specials!</h4>
      <button style={button}>Online Menu</button>
    </div>
    <div
      style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", justifyContent:"center", flexWrap:"wrap", gap:"30px" }}
    >
      <article style={article}>
        ...
        <span style={{textAlign:"left", fontSize:"16px", margin:"15px 20px", fontWeight:"500"}}>Order a delivery</span>
      </article>
      <article style={article}>
        <img
